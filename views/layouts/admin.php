        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item <?php //echo $menuItem == 'theater' ? 'active' : '';?>">
              <a class="nav-link" href="/admin/theater">Theater</a>
            </li>
            <li class="nav-item <?php //echo $menuItem == 'film' ? 'active' : '';?>">
              <a class="nav-link" href="/admin/film">Film</a>
            </li>
            <li class="nav-item" <?php //echo $menuItem == 'schedule' ? 'active' : '';?>>
              <a class="nav-link" href="/admin/schedule">Schedule</a>
            </li>
          </ul>
          &nbsp;
          <div><a class="btn btn-sm btn-primary" href="/user/signout">Sign out</a></div>
        </div>
      </nav>
    </header>
